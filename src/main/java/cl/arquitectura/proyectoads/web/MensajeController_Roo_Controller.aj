...
import cl.arquitectura.proyectoads.web.MensajeController;
...
privileged aspect MensajeController_Roo_Controller {
    ...
    public String MensajeController.show(@PathVariable("id") Integer id, Model uiModel) {
    ...
    public String MensajeController.updateForm(@PathVariable("id") Integer id, Model uiModel) {
        populateEditForm(uiModel, Mensaje.findMensaje(id));
        return "mensajes/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String MensajeController.delete(@PathVariable("id") Integer id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    void MensajeController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("mensaje_fechaenvio_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
